		...
		<nav id="sidebar" class="sidebar">
			<div class="sidebar-content js-simplebar">
				<router-link class="sidebar-brand" to="/admin/dashboard">
          			<span class="align-middle">CodeLabs Admin</span>
        		</router-link>
				...
				<ul class="sidebar-nav">
					...
					<li class="sidebar-item">
						<router-link class="sidebar-link" to="/admin/companies">
							<i class="align-middle" data-feather="square"></i> <span class="align-middle">Empresas</span>
						</router-link>
					</li>

					 <li class="sidebar-item">
						<router-link class="sidebar-link" to="/admin/stevedors">
							<i class="align-middle" data-feather="codepen"></i> <span class="align-middle">Estivadores</span>
						</router-link>
					</li>

					<li class="sidebar-item">
						<router-link class="sidebar-link" to="/admin/typeoperations">
							<i class="align-middle" data-feather="truck"></i> <span class="align-middle">Tipo de Operações</span>
						</router-link>
					</li>

					<li class="sidebar-item">
						<router-link class="sidebar-link" to="/admin/transactions">
						...
						<div class="dropdown-menu dropdown-menu-start dropdown-mega" aria-labelledby="megaDropdown">
							<div class="d-md-flex align-items-start justify-content-start">
								<div class="dropdown-mega-list">
									...
									<router-link to="/admin/companies/create" class="dropdown-item" >Empresas</router-link>
									<router-link to="/admin/typeoperations/create" class="dropdown-item" >Tipos de Operações</router-link>
									
								</div>
								<div class="dropdown-mega-list">
									<div class="dropdown-header">Páginas</div>
									<router-link to="/admin/users" class="dropdown-item" >Usuários</router-link>
									<router-link to="/admin/companies" class="dropdown-item" >Empresas</router-link>
									<router-link to="/admin/typeoperations" class="dropdown-item" >Tipos de Operações</router-link>
									<router-link to="/admin/transactions" class="dropdown-item" >Transações</router-link>
								</div>
						...
						<div class="col-6 text-right">
							<ul class="list-inline">
								...
								<li class="list-inline-item">
									<router-link to="/admin/dashboard" class="text-muted" href="#">CodeLabs</router-link>
								</li>
