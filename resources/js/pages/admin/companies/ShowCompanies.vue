...
const getData = () => {
  axios.get(`/companies/+${router.currentRoute.value.params.id}`)
       .then((response)=>{
                                        ...
                                        <div class="row">
                                            <div class="col-xl-12 col-xxl-12 d-flex">
                                                <div class="w-100">
                                                    ...
                                                    <p>NUIT: {{ retrievedData.nuit }}</p>
                                                    <p>Representante: {{ retrievedData.user.name }} / {{ retrievedData.user.email }}</p>
