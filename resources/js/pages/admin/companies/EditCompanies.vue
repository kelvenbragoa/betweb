...
const getData = () => {
  axios.get(`/companies/+${router.currentRoute.value.params.id}/edit`)
       .then((response)=>{

        retrievedData.value = response.data.company;
...
const editFunction = (values, actions) => {
  ...
  axios.patch(`/companies/${retrievedData.value.id}`,values).then((response)=>{
                                                    ...
                                                    <Form @submit="editFunction" :validation-schema="schema" v-slot="{ errors }">
                                                        ...
                                                        <div class="row">
                                                            <div class="mb-3 col-md-12">
                                                                <label class="form-label" for="companyname">Nome</label>
                                                                <Field type="text" class="form-control" :class="{'is-invalid':errors.companyname}" v-model="retrievedData.name" name="companyname" id="companyname" placeholder="Nome"/>
                                                        ...
                                                        <div class="row">
                                                            <div class="mb-3 col-md-12">
                                                                ...
                                                                <Field type="text" class="form-control" :class="{'is-invalid':errors.address}" v-model="retrievedData.address" name="address" id="address" placeholder="Enderço"/>
                                                        ...
                                                        <div class="row">
                                                            <div class="mb-3 col-md-12">
                                                                ...
                                                                <Field type="text" class="form-control" :class="{'is-invalid':errors.nuit}" v-model="retrievedData.nuit" name="nuit" id="nuit" placeholder="NUIT"/>
