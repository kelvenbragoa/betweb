                                            ...
                                            <div class="col-sm-6 col-xl-3">
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="mb-0">
                                                             <router-link to="/admin/stevedors"><vue-feather type="eye"></vue-feather></router-link>
                                                        </div>
                                            ...
                                            <div class="col-sm-6 col-xl-3">
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="mb-0">
                                                             <router-link to="/admin/transactions"><vue-feather type="eye"></vue-feather></router-link>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <!-- <div class="col-sm-6 col-xl-3">
                                                <div class="card">
                                                    <div class="card-body">
                                                        <div class="row">
                                                            <div class="col mt-0">
                                                                <h5 class="card-title">Estivadores com flag</h5>
                                                            </div>
                                                        ...
                                                        <h1 class="mt-1 mb-3">{{stevedors_with_flag}}</h1>
                                                        <div class="mb-0">
